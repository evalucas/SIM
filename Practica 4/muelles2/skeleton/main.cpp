...
extern void initSpringDemo();
extern void endSpringDemo();
extern void keyPressedSpringDemo(unsigned char key, const physx::PxTransform& camera);
...
{
	PX_UNUSED(camera);
	keyPressedSpringDemo(key, camera);
